...
Tests must never touch your real `./data/sahar` file. Add `src/test/resources/application.properties`, which Boot uses instead of the main one when tests run:
...
Prev: [05 - Validation and rules](./05-validation-and-rules.md) | Next: [07 - Full CRUD](./07-full-crud.md) | Checkpoint: [step-06-jdbctemplate-h2](../../checkpoints/step-06-jdbctemplate-h2/)
